...
def same_question(candidate: dict, previous: dict) -> tuple[int, str]:
    ...
    complained about on 2026-08-23: Gmail `1a02dc9438edb490` at 08:40 UTC and
    `1a02e006586680d8` at 09:40 UTC asked the same choice about the same three
...
# ---------------------------------------------------------------------------
#
# 2026-08-20 18:15 UTC письмо `1a02063a8c4aa0c3` сказало «передайте ему
...
# внешнему стенду. `gigachat-instruction-adherence-findings.md` соседней задачи
