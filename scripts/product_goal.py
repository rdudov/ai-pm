...
# Tasks live in the development contour; the product owner only reads them. The
# override exists for tests and for a check against a copy, never for production.
TASKS_REPO = Path(os.environ.get("PRODUCT_OWNER_TASKS_REPO")
